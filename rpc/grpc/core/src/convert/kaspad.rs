...
pub mod kaspad_request_convert {
    ...
    impl_into_kaspad_request!(GetMinerStatus);
    impl_into_kaspad_request!(ControlMiner);
    ...
    impl_into_kaspad_request!(NotifyNotesChanged);
...
pub mod kaspad_response_convert {
    ...
    impl_into_kaspad_response!(GetMinerStatus);
    impl_into_kaspad_response!(ControlMiner);
    ...
    impl_into_kaspad_notify_response!(NotifyNotesChanged);
